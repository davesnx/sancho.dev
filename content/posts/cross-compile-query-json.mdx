...
Using js_of_ocaml in dune is as easy as adding a flag in the dune file. Using the same build command you have an artifact in JavaScript 🤯 . It will compile any library to JavaScript.
