...
Since then I've wanted query-json to support real jq: generators, catchable errors, loops, early exit. jq is [Turing-complete](https://github.com/MakeNowJust/bf.jq) if you need convincing. The interpreter I started with had none of that. It assumed one input, one output, and no way to stop or recover mid-pipeline.
...
## The previous (simpler) interpreter
