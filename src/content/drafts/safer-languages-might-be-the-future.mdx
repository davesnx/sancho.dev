...
SKILLS
state: full-draft
next: post-sand — post body (from "Agentic AI represents..." to the end) is complete prose; reading-list/cut-content scaffolding at the top needs stripping
then: post-review
note: duplicate — a newer version lives in src/content/posts/safer-languages-might-be-the-future.mdx; probably delete this copy
*/}
