...
SKILLS
state: partial
next: post-draft — intro and styled-ppx origin are prose, but "First users" is "xx", and "Hired"/"Migrated" sections are empty or bullets; personal story, no research needed
