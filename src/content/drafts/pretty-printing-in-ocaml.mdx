...
description: "A modern, combinator-based approach to pretty-printing in OCaml"
...
SKILLS
state: full-draft
next: post-sand — complete Fmt tutorial from `'a Fmt.t` through combinators, boxes, styling, and quick reference; needs a tightening/English pass
then: post-review
*/}
