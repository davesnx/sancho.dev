...
description: "From Printf.sprintf to understand one of OCaml's most elegant type system tricks"
...
SKILLS
state: full-draft
next: post-draft — execute the ASSESSMENT plan: add the "mistakes I still make" and library-author checklist sections, a TOC, and a stronger "you can stop here" split before the GADT internals
