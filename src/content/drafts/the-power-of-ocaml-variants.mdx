...
SKILLS
state: partial
next: post-draft — intro and "how are types organised" have prose, but everything from "Variants" heading onward is bullets/TODOs ("Explain match statement", links to find)
