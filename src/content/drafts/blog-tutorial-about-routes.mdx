...
SKILLS
state: partial
next: post-draft — intro, setup, binding-operators interlude and matching internals are full prose, but "Core Types", "First Route", "Composing", both Advanced sections and Conclusion are TODO comments
