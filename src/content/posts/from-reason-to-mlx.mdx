...
It's just one language, OCaml. There are no 2 languages, here: mlx is an extension.
...
Reason has been in maintenance mode for a few years, and the momentum is long gone. There are some fundamental bugs (like refmt bugs or broken syntax such as classes, that have no plans on being fixed). It's sad to say that about a project I believed in and helped maintain. But maybe mlx is the next chapter we should work on. What do you think?
