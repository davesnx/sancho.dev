...
SKILLS
state: full-draft
next: post-draft — execute the ASSESSMENT plan: add "Common gotchas" and "Debugging workflow" sections plus the build-your-own exercise on top of the complete regex-to-log-parser draft
