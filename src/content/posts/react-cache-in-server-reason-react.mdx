...
description: "How React.cache works in Server components"
...
SKILLS
state: full-draft
next: post-sand — complete prose from mental model to takeaway (data model, request scope, error semantics); needs a simplify/tighten pass before review
then: post-review
*/}
