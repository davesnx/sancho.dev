...
SKILLS
state: partial
next: post-draft — the "Migrations are hard" section breaks off mid-sentence ("it's still") and the commented Resources block (Elm-at-X links, "draw some conclusions") is still unprocessed
