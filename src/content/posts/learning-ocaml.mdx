...
- [Memory managment](#learning-about-memory-management)
  {/_ - [open/closed polyvariants](#learning-open-polyvariants) _/}
  {/_ polymorphic https://v2.ocaml.org/releases/4.07/htmlman/polymorphism.html _/}
  {/_ local modules _/}
...
{/_ ### Syntax _/}
{/_ Syntax matters _/}
{/_ Explain ; being a function _/}
{/_ Explain ;; being a eval _/}
{/_ Explain in being a scope _/}
{/_ Mention ReasonML _/}
