...
description: "The list of cool Reason syntax features we will miss in mlx"
...
We win in ease of maintenance, simplicity of tooling and a fresh start. mlx is OCaml's parser plus [the JSX rules](https://github.com/ocaml-mlx/mlx/blob/main/mlx/parser.mly), and [ocamlformat-mlx](https://github.com/ocaml-mlx/ocamlformat-mlx) is ocamlformat plus a small patch. Updating to a new OCaml version is easy. ocamlformat-mlx reads the same `.ocamlformat` file, and ocaml-lsp-server supports `.mlx` files.
